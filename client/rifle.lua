...
RegisterNetEvent('nexusammo:useRifleAmmo')
AddEventHandler('nexusammo:useRifleAmmo', function()
    local src = source

    if lib.progressCircle({
        label = 'Unpacking Rifle Ammo....',
        duration = 5000,
        ...
        TriggerServerEvent('nexusammo:addRifleAmmo')
    end
end)
