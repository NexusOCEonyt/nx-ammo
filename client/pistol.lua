...
RegisterNetEvent('nexusammo:usePistolAmmo')
AddEventHandler('nexusammo:usePistolAmmo', function()
    local src = source

    if lib.progressCircle({
        label = 'Unpacking Pistol Ammo....',
        duration = 5000,
        ...
        TriggerServerEvent('nexusammo:addPistolAmmo')
    end
end)
