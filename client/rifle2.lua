...
RegisterNetEvent('nexusammo:useRifle2Ammo')
AddEventHandler('nexusammo:useRifle2Ammo', function()
    local src = source

    if lib.progressCircle({
        label = 'Unpacking AK Ammo....',
        duration = 5000,
        ...
        TriggerServerEvent('nexusammo:addRifle2Ammo')
    end
end)
